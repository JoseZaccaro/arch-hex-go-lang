...
type User struct {
	...
	RoleID       interface{} `json:"role_id" bson:"role_id" sql:"role_id"`
...
type UserDB struct {
	...
	ID           interface{} `gorm:"primaryKey" json:"id" bson:"_id" sql:"id"`
	Username     string      `json:"username" bson:"username" sql:"username"`
	Email        string      `json:"email" bson:"email" sql:"email"`
	PasswordHash string      `json:"-" bson:"password_hash" sql:"password_hash"`
	RoleID       interface{} `json:"role_id" bson:"role_id" sql:"role_id"`
...
type UserCreateParams struct {
	...
	RoleID       string `json:"role_id" bson:"role_id" sql:"role_id"`
}
